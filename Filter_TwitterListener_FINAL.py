...
class Filter(tweepy.Stream):   
    ...
    def on_status(self, status):   
        ...
        # logic to close the connection after a certain number of tweets are retrieved
        ...
        # inserts a field that will let us know what keyword was used to filter an individual tweet  
    ...
    #ensures that each record has a field that indicates the specific phrase that was used to filter it out of the stream 
